...
- Generated (UTC): `2026-03-10T15:25:42+00:00`
- Mode: `mock`
...
## Harness Log
- File: `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/harness.log`
```text
HARNESS|mode|PASS|running mode=mock
HARNESS|artifacts|PASS|writing artifacts to artifacts/demo/3min-offline/harness
...
## Validator Log
- File: `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/validator.log`
```text
Validation passed: env format is compatible with offline testnet setup.
```

## Smoke Log
- File: `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/smoke.log`
```text
...
- File: `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/integration.log`
```text
(no output)
```
...
- `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/validator.log`
- `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/smoke.log`
- `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/integration.log`
- `/home/anish/hedera-shield/artifacts/demo/3min-offline/harness/harness.log`
